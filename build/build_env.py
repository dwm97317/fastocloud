    ...
    def get_system_libs(self):
        ...
        if platform_name == 'linux':
            ...
            if distribution == 'DEBIAN':
                ...
                dep_libs = ['gcc', 'gcc-c++', 'git', 'make', 'cmake',
                            'autoconf', 'automake', 'libtool', 'cairo-gobject-devel',
            ...
            dep_libs = ['gcc', 'git', 'make', 'cmake',
                        'autoconf', 'automake', 'libtool', 'cairo',
                        'openssl',
                        'libxcb', 'libdrm', 'libsoup', 'libx264',  # 'libpciaccess-devel',
                        'libudev-devd', 'libjpeg-turbo', 'lzlib', 'libffi', 'pcre', 'yasm',
                        'nasm', 'bison', 'flex', 'alsa-lib', 'ninja', 'librtmp',
                        'gdk-pixbuf2',
                        'libproxy']
        else:
